  ...
  return (
    <section className="user-dash-main">
      <div>
        ...
        <KidTransaction amount={sub(props.budget.balance, props.budget.amount)}/>
...
export default connect(mapStateToProps, { getKidBudget, getPurchase, updateKidBudget })(UserDashboard);
